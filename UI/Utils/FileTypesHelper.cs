...
public static class FileTypesHelper {
    public static FilePickerFileType Word => new("Word OpenXML files") {
        Patterns = ["*.docx"],
        AppleUniformTypeIdentifiers = ["org.openxmlformats.wordprocessingml.document"],
        MimeTypes = ["application/vnd.openxmlformats-officedocument.wordprocessingml.document"]
    };
    
    public static FilePickerFileType Excel => new("Excel OpenXML files") {
        Patterns = ["*.xlsx"],
        AppleUniformTypeIdentifiers = ["org.openxmlformats.spreadsheetml.sheet"],
        MimeTypes = ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"]
    };
    
    public static FilePickerFileType Powerpoint => new("Powerpoint OpenXML files") {
        Patterns = ["*.pptx"],
